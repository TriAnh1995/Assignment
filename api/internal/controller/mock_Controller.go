...
// AddSubscription provides a mock function with given fields: ctx, userEmails
func (_m *MockController) AddSubscription(ctx context.Context, userEmails []string) error {
