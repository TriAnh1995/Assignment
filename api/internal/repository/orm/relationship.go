...
type Relationship struct {
	...
	Subscription string `boil:"subscription" json:"subscription" toml:"subscription" yaml:"subscription"`
	Friendship   string `boil:"friendship" json:"friendship" toml:"friendship" yaml:"friendship"`
...
var RelationshipTableColumns = struct {
	...
	FriendshipID: "relationship.friendship_id",
	UserEmail1:   "relationship.user_email_1",
	UserEmail2:   "relationship.user_email_2",
...
var RelationshipWhere = struct {
	...
	Subscription whereHelperstring
	Friendship   whereHelperstring
}{
	FriendshipID: whereHelperint{field: "\"relationship\".\"friendship_id\""},
	UserEmail1:   whereHelperstring{field: "\"relationship\".\"user_email_1\""},
	UserEmail2:   whereHelperstring{field: "\"relationship\".\"user_email_2\""},
	Subscription: whereHelperstring{field: "\"relationship\".\"subscription\""},
	Friendship:   whereHelperstring{field: "\"relationship\".\"friendship\""},
}
...
var (
	relationshipAllColumns            = []string{"friendship_id", "user_email_1", "user_email_2", "subscription", "friendship"}
	relationshipColumnsWithoutDefault = []string{"user_email_1", "user_email_2", "subscription", "friendship"}
	relationshipColumnsWithDefault    = []string{"friendship_id"}
	relationshipPrimaryKeyColumns     = []string{"friendship_id"}
...
func FindRelationship(ctx context.Context, exec boil.ContextExecutor, friendshipID int, selectCols ...string) (*Relationship, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"relationship\" where \"friendship_id\"=$1", sel,
	)
...
func (o *Relationship) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"relationship\" WHERE \"friendship_id\"=$1"
...
func (o *Relationship) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindRelationship(ctx, exec, o.FriendshipID)
	if err != nil {
		return err
	}
...
func RelationshipExists(ctx context.Context, exec boil.ContextExecutor, friendshipID int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"relationship\" where \"friendship_id\"=$1 limit 1)"
...
func (o *Relationship) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return RelationshipExists(ctx, exec, o.FriendshipID)
}
