...
type Subscription struct {
	...
	Requester      string `boil:"requester" json:"requester" toml:"requester" yaml:"requester"`
...
var SubscriptionTableColumns = struct {
	...
	Requester:      "subscription.requester",
...
var SubscriptionWhere = struct {
	...
	Requester      whereHelperstring
	Target         whereHelperstring
	Status         whereHelperstring
}{
	SubscriptionID: whereHelperint{field: "\"subscription\".\"subscription_id\""},
	Requester:      whereHelperstring{field: "\"subscription\".\"requester\""},
	Target:         whereHelperstring{field: "\"subscription\".\"target\""},
	Status:         whereHelperstring{field: "\"subscription\".\"status\""},
}
...
var (
	subscriptionAllColumns            = []string{"subscription_id", "requester", "target", "status"}
	subscriptionColumnsWithoutDefault = []string{"requester", "target", "status"}
	subscriptionColumnsWithDefault    = []string{"subscription_id"}
...
func FindSubscription(ctx context.Context, exec boil.ContextExecutor, subscriptionID int, selectCols ...string) (*Subscription, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"subscription\" where \"subscription_id\"=$1", sel,
	)
...
func (o *Subscription) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"subscription\" WHERE \"subscription_id\"=$1"
...
func (o *Subscription) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindSubscription(ctx, exec, o.SubscriptionID)
	if err != nil {
		return err
	}
...
func SubscriptionExists(ctx context.Context, exec boil.ContextExecutor, subscriptionID int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"subscription\" where \"subscription_id\"=$1 limit 1)"
...
func (o *Subscription) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return SubscriptionExists(ctx, exec, o.SubscriptionID)
}
